C = {}
local util = require "onitheme.lib.util"
...
function M.load(theme)
  ...
  local highlights = {}
  highlights = util.get_hl_modules(highlights, "onitheme.groups", {
    "base",
    "syntax",
    "lsp",
    "oninvim",
  ...
  highlights = util.get_hl_modules(highlights, "onitheme.groups.plugins", M.config.plugins, M.config)
...
function M.setup(opts)
  M.config = require("onitheme.lib.config").user_config(opts)
